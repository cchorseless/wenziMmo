module SheetConfig{ export class  mydb_drugbuff_tbl { public data;private _instance; public constructor(data){ this.data=data;}
public static getInstance(data): mydb_drugbuff_tbl { let Class:any=this;if(!Class._instance){Class._instance=new Class(data);}return Class._instance;}
/**
 *  id顺序
 */
 ...
 *  BUFF是否会显示给玩家看
 */
 public ISDISPLAY(configID):number { return this.data[configID][20]}
/**
 *  BUFF的显示图标
 */
 ...
 *  显示id
 */
 public DISPLAY(configID):number { return this.data[configID][23]}
/**
 *  buff类型
 */
 public DISPLAYTYPE(configID):number { return this.data[configID][24]}
/**
 *  出发概率
 */
 public TRIGGER_PROBABILITY(configID):number { return this.data[configID][25]}
}}