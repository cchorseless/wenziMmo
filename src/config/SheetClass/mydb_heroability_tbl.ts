module SheetConfig {
    export class mydb_heroability_tbl {
        private data; private _instance; public constructor(data) { this.data = data; }
        public static getInstance(data): mydb_heroability_tbl { let Class: any = this; if (!Class._instance) { Class._instance = new Class(data); } return Class._instance; }
        /**
         *  deleted
         */
         ...
         *  升级所需经验
         */
        public EXCEL(configID: string): number { return this.data[configID][1] }
        /**
         *  战士HP
         */
         ...
         *  战士RestoreHp
         */
        public WARRIORATK_RESTOREHP(configID: string): number { return this.data[configID][50] }
        /**
         *  道士RestoreHp
         */
        public MASTERATK_RESTOREHP(configID: string): number { return this.data[configID][51] }
        /**
         *  法师RestoreHp
         */
        public TAOISTATK_RESTOREHP(configID: string): number { return this.data[configID][52] }
        /**
         *  战士RestoreMp
         */
        public WARRIORATK_RESTOREMP(configID: string): number { return this.data[configID][53] }
        /**
         *  道士RestoreMp
         */
        public MASTERATK_RESTOREMP(configID: string): number { return this.data[configID][54] }
        /**
         *  法师RestoreMp
         */
        public TAOISTATK_RESTOREMP(configID: string): number { return this.data[configID][55] }
    }
}