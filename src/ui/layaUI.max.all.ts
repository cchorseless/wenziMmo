...
module ui.main {
    export class MainPanelUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":640,"height":1136},"child":[{"type":"Image","props":{"y":0,"x":0,"top":0,"skin":"image/common/bg.jpg","right":0,"left":0,"bottom":0}},{"type":"Box","props":{"var":"box_mainTop","top":0,"right":0,"left":0},"child":[{"type":"Image","props":{"top":0,"skin":"image/main/bg_top.png","right":0,"left":0}},{"type":"Image","props":{"top":0,"skin":"card_top_bg.png","right":0,"left":0}}]},{"type":"Label","props":{"y":863,"x":127,"width":388,"text":"这是游戏主界面","height":80,"fontSize":40,"font":"Microsoft YaHei","bold":true}},{"type":"Box","props":{"var":"box_mainBottom","right":0,"left":0,"bottom":0},"child":[{"type":"Image","props":{"skin":"image/main/bg_bottom.png","right":0,"left":0,"bottom":0}},{"type":"Button","props":{"x":1,"stateNum":2,"skin":"image/main/role_norm_finish.png","left":1,"label":"label","bottom":0}},{"type":"Button","props":{"x":131,"stateNum":2,"skin":"image/main/state_up_finish.png","label":"label","bottom":0}},{"type":"Button","props":{"x":260,"stateNum":2,"skin":"image/main/skill_up_finish.png","label":"label","bottom":0}},{"type":"Button","props":{"x":519,"stateNum":2,"skin":"image/main/map_norm_finish.png","right":1,"label":"label","bottom":0}},{"type":"Button","props":{"x":390,"stateNum":2,"skin":"image/main/shop_up_finish.png","label":"label","bottom":0}}]},{"type":"Image","props":{"y":737,"skin":"image/main/bg_line.png","right":0,"pivotY":-2,"pivotX":2,"left":0,"height":27}},{"type":"BodyItem","props":{"y":706,"x":158,"var":"ui_mainPlayer","scaleY":1.5,"scaleX":1.5,"runtime":"ui.compart.BodyItemUI"}}]};
        constructor(){ super()}
        createChildren():void {
