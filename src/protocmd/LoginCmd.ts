...
module ProtoCmd {
    ...
    export class CheckSignalCmdRet extends Packet {
        //服务器返回的包类型
    ...
    // ********************************登陆验证
    //登录前验证
    export class UserPreLogin extends Packet {
        //服务器返回的包类型
    ...
    //登录前验证返回
    export class UserRetPreLogin extends Packet {
    ...
    //登录
    export class NormalUserLogin extends UserLogin {
        public constructor() {
            super();
    ...
    //登录返回
    export class UserLoginRet extends Packet {
    ...
    //************************************************ */
    //暂时用不到
    export class TradeUserLogin extends UserLogin {
        public constructor() {
            super();
    ...
    //*********************************验证后登陆 */
    export class UserRealLogin extends Packet {
    ...
    //0x0108
    export class SelectPlayerRet extends Packet {
    ...
    //********************************更新本地token */
    //0x0109
    export class UpdateToken extends Packet {
    ...
    //0x012D
    export class CreatePlayerRet extends Packet {
