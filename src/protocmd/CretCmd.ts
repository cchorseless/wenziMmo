...
module ProtoCmd {
    ...
    export class stCretChangeName extends Packet {
        public static msgID: number = 0x026f;
        public constructor(data: Laya.Byte) {
            super();
            this.addProperty('dwTmpId', PacketBase.TYPE_DWORD);	// 
            this.addProperty('szShowName', PacketBase.TYPE_STRING, Packet._MAX_NAME_LEN);	// 角色名字
            this.addProperty('szMasterName', PacketBase.TYPE_STRING, Packet._MAX_NAME_LEN);	// 主人名字
            this.addProperty('btType', PacketBase.TYPE_DWORD);	// 0:正常，1: 英雄, 2:道士宠物, 3:英雄道士宠物, 4:怪物归属, 5:怪物队伍归属
            this.read(data);
        }
    }
