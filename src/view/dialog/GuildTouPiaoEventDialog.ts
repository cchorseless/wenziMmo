...
module view.dialog {
	export class GuildTouPiaoEventDialog extends ui.dialog.GuildTouPiaoEventDialogUI {
		constructor() {
			super();
		}
		...
		public showInfo(): void {
			new view.dialog.GuildTouPiaoDetailDialog().setData(this.detailInfo).show(false);
		}
	}
}