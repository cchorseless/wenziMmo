		...
		public setTimeShow(data) {
			...
			if (data.achieve != null) {
				...
				this.html_cost.innerHTML = "<span style='color:#554536;font-family:STLiti;fontSize:24;stroke:0.5;strokeColor:#000000'>"
				 + str + "</span>" + "<span style='color:#179a0d;font-family:STLiti;fontSize:24;stroke:0.5;strokeColor:#000000'>" + data.achieve + "</span>";
			}
			else {
				this.html_cost.innerHTML = "";
			}
			this.html_progress.style.align = "center";
			this.html_progress.innerHTML = "<span style='color:#554536;font-family:STLiti;fontSize:24;stroke:0.5;strokeColor:#000000'>当前进度：</span>"
			 + "<span style='color:#179a0d;font-family:STLiti;fontSize:24;stroke:0.5;strokeColor:#000000'>" + data.achieve + "/" + "</span>"
			...
			if (leftTime > 0) {
				Laya.timer.frameLoop(3600, this, function () {
					...
					if (leftTime > 0) {
						let aa = TimeUtils.getFormatBySecond(leftTime, 6)
						this.html_time.style.align = "center";
						this.html_time.innerHTML = "<span style='color:#554536;font-family:STLiti;fontSize:24;stroke:0.5;strokeColor:#000000'>剩余时间：</span>" + "<span style='color:#a53232;font-family:STLiti;fontSize:24;stroke:0.5;strokeColor:#000000'>" + aa + "</span>";
					}
				});
			}
		}
